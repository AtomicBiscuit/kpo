...
class CustomerStorageTests {
    ...
    void addCustomerTest() {
        var customer = Customer.builder().name("Vladislav").legPower(7).handPower(3).iq(42).build();
    ...
    void addManyCustomersTest() {
        ...
        range(0, 10).forEach(number -> customers.add(
                Customer.builder().name("Anton " + number).legPower(2).handPower(3).iq(104).build())
        );
